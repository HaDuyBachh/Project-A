...
namespace HaDuyBach
{
    public class PlayerHandGunState : PlayerBaseState, IWeaponState
    {
        public PlayerHandGunState(ThirdPersonController currentContext, PlayerStateFactory playerStateFactory)
        ...
        public override void EnterState()
        {
            ...
            //Debug.Log("Đang vào Handgun State");
        ...
        {
            //Debug.Log("Đang thoát handgun State");
        }
